...
from networks.maddpg_critic_version_2 import MADDPGCriticVersion2
...
"""
class MADDPGAgentVersion3(BaseAgent):
    def __init__(self, game, num_agents, state_size, action_size, name, random_seed=0,
        ...
        self.critic_local = MADDPGCriticVersion2(num_agents, state_size, action_size, 
                                                 fcs1_units=fc1_units, fc2_units=fc2_units,
                                                 seed=random_seed).to(device)
        self.critic_target = MADDPGCriticVersion2(num_agents, state_size, action_size, 
                                                  fcs1_units=fc1_units, fc2_units=fc2_units,
                                                 seed=random_seed).to(device)
