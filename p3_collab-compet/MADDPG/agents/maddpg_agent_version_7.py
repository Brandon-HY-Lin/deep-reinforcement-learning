...
from networks.maddpg_critic_version_4 import MADDPGCriticVersion4
from networks.maddpg_actor_version_3 import MADDPGActorVersion3
from agents.base_agent import BaseAgent
from agents.game import Game
from utils.ounoise import OUNoise
from utils.experience_pack_version_2 import ExperienceUnpackVersion2
...
MADDPGAgent (Version 7)
    ...
    5. Removing update function from learn(). Agent Group should call it.
    6. Fix bug in maddpg_agent_verion_5. Replace actions with action_pred in self.critic_local()
    7. Remove torch.manual_seed in critic and actor networks.
"""
class MADDPGAgentVersion7(BaseAgent):
...
#             pdb.set_trace()
    ...
    def learn(self, states, actions, rewards, next_states, dones):
        ...
        experience_unpacks = ExperienceUnpackVersion2(states, actions, rewards, next_states, dones,
